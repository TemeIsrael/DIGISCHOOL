  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <KPICard value="12.1" label={t('directeur.avgGrade')} icon={<TrendingUp className="w-5 h-5 text-digi-purple" />} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="shadow-sm border border-slate-100 p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center"><span className="text-sm">{"<"} 8/20</span><div className="flex items-center gap-2"><div className="w-32 h-2 bg-red-100 rounded-full overflow-hidden"><div className="h-full bg-red-500 rounded-full" style={{ width: '10%' }} /></div><span className="text-xs font-bold text-red-600">10%</span></div></div>
            <div className="flex justify-between items-center"><span className="text-sm">8 - 10</span><div className="flex items-center gap-2"><div className="w-32 h-2 bg-amber-100 rounded-full overflow-hidden"><div className="h-full bg-amber-500 rounded-full" style={{ width: '20%' }} /></div><span className="text-xs font-bold text-amber-600">20%</span></div></div>
            <div className="flex justify-between items-center"><span className="text-sm">10 - 14</span><div className="flex items-center gap-2"><div className="w-32 h-2 bg-blue-100 rounded-full overflow-hidden"><div className="h-full bg-blue-500 rounded-full" style={{ width: '45%' }} /></div><span className="text-xs font-bold text-blue-600">45%</span></div></div>
            <div className="flex justify-between items-center"><span className="text-sm">{">"} 14/20</span><div className="flex items-center gap-2"><div className="w-32 h-2 bg-emerald-100 rounded-full overflow-hidden"><div className="h-full bg-emerald-500 rounded-full" style={{ width: '25%' }} /></div><span className="text-xs font-bold text-emerald-600">25%</span></div></div>
          </div>
        </Card>
        <Card className="shadow-sm border border-slate-100 p-6">
